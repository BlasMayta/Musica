         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">¿Que son las Notas Musicales?</h1>
                        <hr>
                        <p> Las notas musicales son sonidos musicales, mejor conocidos como tonos,
                        que pueden ser ejecutados o interpretados en cualquie instrumento
                        musical, incluyendo la voz. Son la base para conceptos musicales más complejos
                        que se utilizan en la música: escalas, tonalidades, acordes, melodías.</p>
                           
                            <img src="" alt="">

                        <h1 class="hymn-title">Nombres de las Notas</h1>
                         <hr>
                        <p>Los sitemas de notacion principales son:
                          El sistema Latino y el sistema Anglosajon.
                          A continuacion se vera sus Equivalencias.</p>
                            <img src="" alt="">
                        
                          <h1 class="hymn-title">Clasificacion de Las Notas</h1>
                          <hr>
                          <p>Existen dos pequeños grupos en los que pueden clasificarse las doce notas musicales, son:
                            naturales: que son los siete sonidos básicos que todos conocemos: do, re, mi, fa, sol, la, si.
                            alteradas: son las mismas notas musicales naturales, pero alteradas cromáticamente en forma ascendente,
                            colocándoles un sostenido (#) o descendente, colocándoles un bemol (b). Son: do# o reb, re# o
                            mib, fa# o fab, sol# o lab, la# o sib.</p>
                            <hr>

                            <p>Básicamente, las notas musicales naturales corresponden a las teclas blancas del piano,
                              y las notas musicales alteradas corresponden a las teclas negras del piano:</p>
                            <img src="" alt="">
