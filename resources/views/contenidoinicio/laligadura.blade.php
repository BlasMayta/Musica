         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">¿Que son las Ligaduras?</h1>
                        <hr>
                        <p> La Ligadura son la Prolongacion es un simbolo (linea curva) que suma la duracion de dos o mas figuras. 
                          Esta puede extenderce por las compases que se an requerido.
                        </p>
