         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">¿Que son las Figuras Musicales?</h1>
                        <hr>
                        <p> Las Figuras Muiscales son simbolos que por si solos nmos indican la duracion
                          y al encontrarlos en un pentagrama representaran un o silencio .
                          Las figuras poseen un balor absoluto, que es intrensico y un valor relativo,
                          que es extrensico y depende de la indicacion de compas</p>
                           
                            <img src="" alt="">

                        <h1 class="hymn-title">Partes de la Figura</h1>
                         <hr>
                        <p>Todas las figuras musicales están formadas por tres partes que se conocen con el nombre de
                          corchete, plica y cabeza. La redonda es una excepción, ya que no tiene ni plica ni corchete.</p>
                            <img src="" alt="">
