         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">¿Que son los Puntillos?</h1>
                        <hr>
                        <p> El puntillo es un simbolo que añade la mitad  de duracion de lafigura que lo posee.</p>
                           
                            <img src="" alt="">

                        <h1 class="hymn-title">Lista de Puntillos</h1>
                         <hr>
                        <p>Existen ademas: el doble, el triple y el cuadruple puntillo añade la mitad del anterior</p>
                            <hr>
                            <h3 class="hymn-title">Por Ejemplo</h3>
                            <p>Un Blanca con doble puntillo equivaldria a 3 y 1/2 tiempos</p>
