         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">¿Que son los trisillos?</h1>
                        <hr>
                        <p> El trisillo considte en dividir en tres partes aquellos que normalmente dividiriamos e dos partes iguales.
                          Se escribe encima de ellos un tres (3) que indica su nuevo valor.
                        </p>
                           
                            <img src="" alt="">

                        <h3 class="hymn-title">Por Ejemplo</h3>
                         <hr>
                        <p>Dos Corcheas serian un grupo naturan que equivaldria a 1 tiempo, en este caso se dividiria en 3 corcheas quoted_printable_decode
                          equivalen a la misma duracion como grupo.
                        </p>
                            <img src="" alt="">
