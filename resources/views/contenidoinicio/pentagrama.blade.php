...
<head>
  ...
  <link rel="stylesheet" href="contimagen/css/styleimg.css"> 
  <!-- Responsive-->
         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    <div class="col-md-3 right-content  ">
                        <img  src="contimagen/img/lin.png" alt="">
                    </div>
                    <div class="col-md-6 left-content">
                        <h1 class="hymn-title">QUE ES LA PENTAGRAMA</h1>
                        <hr>
                        <p> Un pentagrama musical, básicamente, consiste en cinco líneas trazadas
                            horizontalmente y paralelas entre sí, separadas por la misma distancia.
                            Entre ellas se forman cuatro espacios, que son tan importantes como las líneas para
                            la escritura de la música: </p>
                           
                            <img src="contimagen/img/linea.png" alt="">

                        <h1 class="hymn-title">¿Para qué sirve el pentagrama?</h1>
                         <hr>
                        <p>La función del pentagrama es contener todos los símbolos que representan la música.
                            lo que debemos saber es que las líneas y espacios definen la altura de los sonidos, es decir, los tonos.</p>
                            <img src="contimagen/img/par.png" alt="">
                        
                          <h1 class="hymn-title">Líneas y espacios adicionales en el pentagrama</h1>
                          <hr>
                          <p>Este recurso se utiliza para escribir notas musicales por encima del rango de
                            altura que admite el pentagrama, o por debajo del mismo.</p>
                            <img src="contimagen/img/esp.png" alt="">
