...
<div class="container">
  <div class="row">
    ...
    <div class= "box-item col-md-4">
      <div class="flip-box">
        <div class="flip-box-front text-center" style="background-image: url('https://i.postimg.cc/8krJ4Bqm/1.png');">
          <div class="inner color-white">
              <h3 class="flip-box-header">JUEGO MENTAL </h3>
              <p>En cual el Juego Consiste en Reconocer imagenes </p>

              <img src="https://s25.postimg.cc/65hsttv9b/cta-arrow.png" alt="" class="flip-box-img">
          </div>

        </div>
        <div class="flip-box-back text-center" style="background-image: url('https://i.postimg.cc/8krJ4Bqm/1.png');">
          <div class="inner color-white">
          <h3 class="flip-box-header">JUEGO MENTAL </h3>
              <p>En cual el Juego Consiste en Reconocer imagenes </p>
              <br>
                ...
                <a class="btn btn-primary" class="flip-box-button" href="{{url('/juegomental')}}">ingrese para ver</a> 
    ...
    <div class= "box-item col-md-4">
      <div class="flip-box">
        <div class="flip-box-front text-center" style="background-image: url('https://i.postimg.cc/SNFXvY4F/2.png');">
          <div class="inner color-white">
        ...
        <div class="flip-box-back text-center" style="background-image: url('https://i.postimg.cc/SNFXvY4F/2.png');">
          <div class="inner color-white">
              <h3 class="flip-box-header">JUEGOS</h3>
              <p>La Metodologia musical se debe </p>
              <p>encotrar factible y practico para los niños</p>
