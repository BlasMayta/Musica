<a class="btn btn-primary" data-toggle="modal" data-target="#editModal{{$tut->id}}" href="{{route('tutor.edit', $tut)}}"><i class="fa fa-pen"></i></a>

  <div class="modal fade" id="editModal{{$tut->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

    <div class="modal-dialog">
        <div class="modal-content bg-info">
            <div class="modal-header">
                <h4 class="modal-title" id="staticBackdropLabel">ACTUALIZAR TUTORES</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {!! Form::model($tut,['route'=> ['tutor.update', $tut], 'method'=>'put', 'class'=>'editar']) !!}
            <div class="form-row">
