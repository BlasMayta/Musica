    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="staticBackdropLabel">NUEVO EVALUACION</h4>    
            </div>
            <div class="modal-body">
                <form action="{{ url('evaluacions') }}" method="post" entype="multipart/form-data">
                    @csrf
                    @include('evaluacion.form', ['modo' => 'Guardar'])
