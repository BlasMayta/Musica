<a class="btn btn-primary" data-toggle="modal" data-target="#editModal{{ $doc->id }}" href="{{ route('docente.edit', $doc) }}">
    <i class="fa fa-pen"></i>
</a>

<div class="modal fade" id="editModal{{ $doc->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body Form-responsive ">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::email('correo', null, ['id' => 'correo', 'name' => 'correo', 'class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="form-row">
