    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="staticBackdropLabel">NUEVO CANCION</h4>    
            </div>
            <div class="modal-body">
                <form action="{{ url('cancions') }}" method="post" entype="multipart/form-data">
                    @csrf
                    @include('cancion.form', ['modo' => 'Guardar'])
