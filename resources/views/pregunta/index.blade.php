    ...
    <div class="card-header">
        ...
        <div class="card-body">
            ...
            <div class="float-ring">
                ...
                <a href="{{ url('preguntas/create') }}" class="btn btn-success">
                    <i class="fas fa-plus-square"></i> Nuevo1
                </a>
<br>
<br>
<a href="{{ url('preguntas/show') }}" class="btn btn-success">
                ...
                <table class="table table-striped" id="usuarios">
                    ...
                    <tbody>
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('preguntas/' ) }}" class="d-inline " method="post">
                                        @csrf
                                        {{ method_field('DELETE') }}
