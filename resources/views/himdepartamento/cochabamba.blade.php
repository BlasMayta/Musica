         ...
         <div class="hymn-container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 right-content  ">
                        ...
                        <img src="{{ asset('path/to/imagenescudo.png') }}" alt="Imagen relacionada con el himno" class="img-fluid" >
                        <h3>Video</h3>
                        <video controls class="w-100">
                    
                            <source src= "{{ asset('path/to/videohimnonacional.mp4') }}" type="video/mp4">
                            Tu navegador no soporta la reproducción de video.
                        </video>
                        <h3>Audio</h3>
                        <audio controls class="w-100">
                        
                            <source src="{{ asset('path/to/audiohimnonacional.mp3') }}"type="audio/mpeg">
